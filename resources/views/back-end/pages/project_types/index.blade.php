                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" required
                                        placeholder="Masukkan nama tipe project">
                                </div>
                            </div>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="editModal{{ $type->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <form action="{{ route('project-type.update', $type->id) }}"
                                                            method="POST" class="modal-content">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editModalLabel{{ $type->id }}">Edit Tipe Project
                                                                </h5>
                                                ...
                                                <div class="modal fade" id="deleteModal{{ $type->id }}" tabindex="-1"
                                                    ...
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="{{ route('project-type.destroy', $type->id) }}"
                                                            method="POST" class="modal-content">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="deleteModalLabel{{ $type->id }}">Konfirmasi
                                                                    Hapus</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
