                        ...
                        <form action="{{ route('category-project.store') }}" method="POST" class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="job_type_dropdown" name="job_type_id" class="form-select w-100">
                                        {{-- GANTI class ke form-control --}}
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center align-items-center gap-1">
                                                    <button class="btn btn-warning btn-action-sm text-white" data-bs-toggle="modal"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="name{{ $item->id }}"
                                                                        class="form-label">Nama Category</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label
                                                                        for="job_type_dropdown_edit_{{ $item->id }}"
                                                                        class="form-label">Pilih Pekerjaan</label>
                                                                    <select
                                                                        id="job_type_dropdown_edit_{{ $item->id }}"
                                                                        class="form-select job-type-dropdown">
                                                                        <option value="">Pilih Pekerjaan</option>
                                                                        @foreach ($jobTypes as $jobType)
                                                                    ...
                                                                    <div id="selectedJobTypes_edit_{{ $item->id }}"
                                                                        class="mt-2 d-flex flex-wrap">
                                                                        @foreach ($item->jobTypes as $jt)
                                                                            <span
                                                                                class="badge bg-primary me-2 d-inline-flex align-items-center mb-2">
                                                                                {{ $jt->name }}
                                                                                <button type="button"
                                                                                    class="btn-close btn-close-white btn-sm ms-2"
                                                                                    aria-label="Close"
                                                                                    onclick="removeSelectedJobType('{{ $item->id }}', '{{ $jt->id }}')"></button>
                                                                                <input type="hidden" name="job_types[]"
                                                                                    value="{{ $jt->id }}">
                                                                            </span>
                                                                        @endforeach
                                                                    </div>
                                                ...
                                                <div class="modal fade" id="deleteModal{{ $item->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('category-project.destroy', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
