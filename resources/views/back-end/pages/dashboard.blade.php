                                            ...
                                            <div class="row" style="height: 350px;">
                                                <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                                    <div class="ml-xl-4 mt-3">
                                                        ...
                                                        <h1 class="text-primary">{{ $totalProjects }}</h1>
                                                        <h3 class="font-weight-500 mb-xl-4 text-primary">All Projects</h3>
                                                        <p class="mb-2 mb-xl-0">Total project yang dikelompokkan berdasarkan tipe proyek.</p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                                <table class="table table-borderless report-table">
                                                                    @foreach($projectTypes as $type)
                                                                        @php
                                                                            $percentage = $totalProjects > 0 ? ($type->projects_count / $totalProjects) * 100 : 0;
                                                                            $barColor = ['bg-primary', 'bg-warning', 'bg-danger', 'bg-info', 'bg-success'][($loop->index) % 5];
                                                                        @endphp
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h5 class="font-weight-bold mb-0">{{ $type->projects_count }}</h5>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </table>
                                                        ...
                                                        <div class="col-md-6 mt-3">
                                                            <div class="doughnut-chart-wrapper">
                                                                <canvas id="project-type-doughnut"></canvas>
                                                            </div>
                                                            <div id="project-type-doughnut-legend"></div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mt-3 mb-0">
                                                            ...
                                                            <div id="category-chart-legend"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
